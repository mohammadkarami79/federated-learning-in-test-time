...
# -*- coding: utf-8 -*-
"""
Kim et al., 2023 Reproduction - CLEAN VERSION
==============================================

This script reproduces the experimental setup from Kim et al., 2023
with all encoding issues fixed.
"""
...
def load_defense_components(config: Kim2023Config, logger: logging.Logger):
    ...
    # Load DiffPure model (architecture from main.py)
    if config.USE_DIFFPURE:
        try:
            import torch.nn as nn
            
            # Use TrainedUNet architecture from main.py
            ...
            diffuser = TrainedUNet(
                ...
                hidden_channels=256  # Match checkpoint
...
def main():
    ...
    parser.add_argument('--output-dir', type=str, default='./kim2023_results_clean', help='Output directory')
    ...
    logger.info("============================================================")
    logger.info("KIM ET AL., 2023 REPRODUCTION EXPERIMENT - CLEAN VERSION")
    logger.info("============================================================")
